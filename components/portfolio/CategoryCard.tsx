      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden sm:aspect-[21/9] md:aspect-[2.4/1]">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8 md:p-10">
            <div className="flex flex-col gap-7 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 max-w-xl text-sm leading-relaxed text-white/65 sm:mt-5 sm:text-base">
