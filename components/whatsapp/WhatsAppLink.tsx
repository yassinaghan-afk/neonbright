...
export function WhatsAppLink({
  ...
  return (
    <a
      ...
      className={cn(
        variant === "button" &&
          "inline-flex items-center justify-center gap-2 rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-6 py-3 text-sm font-semibold text-[#25D366] transition-all hover:bg-[#25D366]/20 hover:scale-[1.02]",
        variant === "inline" && "transition-colors hover:text-[#25D366]",
        className
      )}
    >
      {children}
