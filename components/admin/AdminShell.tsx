...
const NAV: NavItem[] = [
  ...
  { href: "/admin/portfolio", label: "Portfolio", icon: "◈", roles: ["owner"] },
  { href: "/admin/testimonials", label: "Testimonials", icon: "◉", roles: ["owner"] },
  { href: "/admin/partners", label: "Partners", icon: "◎", roles: ["owner"] },
  { href: "/admin/services", label: "Services", icon: "◆", roles: ["owner"] },
  { href: "/admin/company", label: "Company & Contact", icon: "◇", roles: ["owner"] },
