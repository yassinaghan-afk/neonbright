...
export function getDefaultCMSContent(): CMSContent {
  ...
  return {
    ...
    contact: {
      ...
      phone: "+212 702 688 416",
      whatsapp: "+212702688416",
      googleMapsUrl: "",
      openingHours: "Lun–Ven : 9h–18h",
    },
    social: {
      instagram: "https://www.instagram.com/_neonbright_?igsh=NHQxN3MzcjJhdGZ0",
      linkedin: "",
      pinterest: "",
      facebook: "https://www.facebook.com/share/1BrrbDuxoB/?mibextid=wwXIfr",
      twitter: "",
    },
    seo: {
