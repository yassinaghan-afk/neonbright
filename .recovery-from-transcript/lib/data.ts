export const navLinks = [
  ...
  { label: "Designer Mon Néon", href: "/designer" },
...
export const commercialStats = [
  { value: "2M€+", label: "Projets commerciaux" },
...
export const industries = [
  { name: "Néons LED personnalisés", icon: "✨" },
  { name: "Enseignes lumineuses", icon: "💡" },
  { name: "Logos lumineux", icon: "◎" },
  { name: "Enseignes commerciales", icon: "🏪" },
  { name: "Signalétique pro", icon: "📍" },
  { name: "Hôtels & Resorts", icon: "🏨" },
  { name: "Restaurants & Bars", icon: "🍸" },
  { name: "Boutiques & Retail", icon: "🛍️" },
  { name: "Corporate", icon: "🏢" },
];
